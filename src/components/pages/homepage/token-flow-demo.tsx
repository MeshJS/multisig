 ...
 * from Blockfrost. The tx list refreshes at most once a day (localStorage
 * TTL); per-tx detail is fetched on demand by the timeline itself.
 */
...
const REFS_CACHE_KEY = "features-demo-txs-v1";
