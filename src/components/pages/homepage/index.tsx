...
// Wrapper component for CardUI with scroll reveal animation
...
// DApp Card Component
function DappCard({ title, description, url, delay = 0 }: { title: string; description: string; url: string; delay?: number }) {
...
export function PageHomepage() {
  ...
  // Scroll-Detection für Aurora Fade-Out
  ...
  return (
    <div className="relative w-full min-h-screen">
      {/* Aurora Background - Fixed mit Smooth Fade-Out */}
      <div
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="mx-auto max-w-4xl text-center">
          <div className="mb-6 flex justify-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-border bg-muted px-4 py-2 text-sm font-medium">
              <span
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
            Free, open-source, Cardano-native wallet by Mesh with multi-signature
            security for teams, organizations and individuals
          </p>
            ...
            {user ? (
              <>
                <Button size="lg" asChild>
                  <Link href="/wallets/new-wallet-flow/save">Create Multi-Sig Wallet</Link>
                </Button>
              ...
              <>
                ...
                <Button size="lg" variant="ghost" asChild>
                  <Link href="#control-treasuries">Learn About Multi-Sig →</Link>
                </Button>
              </>
            )}
          </div>
          ...
          <p className="mt-8 text-sm text-muted-foreground">
            Wallet management • Transactions • Collaboration • Governance • Staking • DApps
          </p>
        </div>
      </section>
      ...
      <section id="control-treasuries" className="container mx-auto px-4 py-16">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-center text-muted-foreground">
            Complete wallet and transaction management with multisig security - including seamless collaboration
          </p>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <AnimatedCard
              ...
              description="Intuitive interface to create new transactions and send to required signers for signatures"
            ...
            <AnimatedCard
              ...
              description="View all your transactions in one place, including who signed it and the transaction's purpose"
              cardClassName="overflow-hidden"
            >
              <div className="mt-4 rounded-lg border border-border p-2">
                <Image
            ...
            <AnimatedCard
              ...
              description="Invite signers to your multisig wallet by simply sharing a link and ensure all your signers are verified and have access to the wallet"
              cardClassName="overflow-hidden"
            >
              <div className="mt-4 rounded-lg border border-border p-2">
                <Image
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-center text-3xl font-bold">
            Governance and Staking as it should be
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-center text-muted-foreground">
            <Link href="/governance" className="text-foreground hover:underline font-medium">
              Explore Governance in Mesh Multi-Sig Wallet
            </Link>
          </p>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3 lg:grid-cols-3">
            <AnimatedCard
              ...
              description="View all Cardano proposals and vote as a team with multi-sig security"
              cardClassName="overflow-hidden"
            >
              <div className="mt-4 rounded-lg border border-border p-2">
                <Image
            ...
            <AnimatedCard
              delay={100}
              title="Register DRep"
              description="Register your team as one Delegated Representative for Cardano governance"
              cardClassName="overflow-hidden"
            >
              <div className="mt-4 rounded-lg border border-border p-2">
                <Image
            ...
            <AnimatedCard
              ...
              description="Delegate stake to pools, manage rewards, control staking operations with multi-signature approval"
              cardClassName="overflow-hidden"
            >
              <></>
            </AnimatedCard>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-center text-muted-foreground">
            Connect your multisig wallet to DApps and integrate it in your workflows
          </p>
          ...
          <div className="mt-12">
            <AnimatedCard
              delay={300}
              title="Build dApps that work seamlessly with multisig wallets"
              description="Integrate Your DApps with Multisig API. Our API provides endpoints for transaction creation, signing, and wallet management."
            >
              <div className="mt-4">
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2">
            <AnimatedCard
              delay={0}
              title="Powered by Mesh SDK"
              description="Mesh is the open-source TypeScript SDK that helps developers write better code and scale applications with ease • 1M+ downloads"
            >
              <div className="mt-4">
                <Button variant="outline" asChild>
                  <Link href="https://meshjs.dev" target="_blank">
                    Mesh SDK
                  </Link>
                </Button>
              </div>
            ...
            <AnimatedCard
              delay={100}
              title="Cardano-Native, Free & Open Source"
              description="Native cardano ecosystem integration • No fees • Open Source development"
            >
              <div className="mt-4">
                <Button variant="outline" asChild>
                  <Link href="https://github.com/MeshJS/multisig" target="_blank">
                    Mesh Multisig Platform on GitHub
                  </Link>
                </Button>
              </div>
            </AnimatedCard>
