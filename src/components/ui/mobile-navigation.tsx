...
export function MobileNavigation({ isWalletPath }: MobileNavigationProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="left" className="w-[240px] sm:w-[260px] p-0 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-xl border-r border-gray-200/30 dark:border-white/[0.03]">
        <SheetHeader className="border-b border-gray-200/30 dark:border-white/[0.03] px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="font-semibold text-base text-foreground">Multisig Platform</span>
            </div>
            <button
